        ...
        <div className={styles.logincard}>
          ...
          <Form onSubmit={handleLogin}>
            ...
            <Form.Group className={styles.label2} controlId="formBasicPassword">
              ...
              <div style={{ marginTop: 20, cursor: 'pointer' }} onClick={() => router.push("/forgotPassword")}><p>Forgot password?</p></div>
            </Form.Group>
          ...
          <p onClick={() => router.push('/signup')} style={{ textAlign: 'center', marginTop: 30, fontSize: 17, cursor: 'pointer' }}>New user? <b>Sign Up</b></p>
        </div>
      </div></>
  )
}
